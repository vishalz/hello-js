 ...
 * 		npm test basic.60 functions
 *
 * @todo declare  variable isEven  
 * Assign  isEven = an anonymous function using a function expression 
 * The function takes one argument as input parameter
 * The function returns true of the input parameter is an even number or false if it an odd number 
 * use remainder operator
 * use if..else statement
 *
 * @todo declare  variable isOdd  
 * Assign  isOdd = an anonymous function using a function expression 
 * The function takes one argument as input parameter
 * The function returns true if the input parameter is an odd  number or false if it an even number 
 * use remainder operator
 * use ternary  operator
 *
 * @todo declare  variable convertToNumber  
 * Assign  convertToNumber = an anonymous function using a function expression 
 * The function takes one argument as input parameter
 * The function converts the input parameter into a number and returns it 
...
// ******** Don't edit below this line *********************** 
	...
	(typeof(isEven)=== 'undefined') || (obj.isEven = isEven); 
	(typeof(isOdd)=== 'undefined') || (obj.isOdd = isOdd); 
	(typeof(convertToNumber)=== 'undefined') || (obj.convertToNumber = convertToNumber); 
